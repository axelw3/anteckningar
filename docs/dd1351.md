...
> **Exempel:** Vi kan bevisa att $0\cdot0=0$ (!).<br>
...
#### Formell semantik
$$\small{\begin{align}&\mathcal M,s\vDash p&\enspace&\text{om }p\in L(s)\\&\mathcal M,s\vDash\lnot\phi&&\text{om \underline{inte} }\mathcal M,s\vDash\phi\\&\mathcal M,s\vDash\phi\land\psi&&\text{om}\ \mathcal M,s\vDash\phi\text{ och }\mathcal M,s\vDash\psi\end{align}}$$
